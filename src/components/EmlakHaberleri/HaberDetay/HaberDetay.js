...
function HaberDetay() {
  ...
  return (
    <>
      <section id='haberDetay' className='relative'>
        <div className="flex lg:flex-row flex-col gap-x-8 lg:mt-6">
          <div className='flex-[1_1_75%]'>
            ...
            <h1 className='lg:text-2xl text-xl font-semibold tracking-wide mt-8 mb-2 block'>Emlak Haberleri için bir adet blog yazısı blog yazısı blog yazısı</h1>
